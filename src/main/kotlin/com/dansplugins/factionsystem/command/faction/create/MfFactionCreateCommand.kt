    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        plugin.server.scheduler.runTaskAsynchronously(
            ...
            Runnable {
                ...
                // Bind faction team to creator's team (or YELLOW if none)
                val creatorTeam = plugin.teamService.getPlayerTeam(mfPlayer.id) ?: com.dansplugins.factionsystem.team.TeamColor.YELLOW
                plugin.teamService.setFactionTeam(createdFaction.id, creatorTeam)
